...
var commands = {
  ...
  michaelexify:(victim, param)=>{
    if(victim.level<1 || !victim.room.usersPublic[param]) return;
    victim.room.usersPublic[param].color = "michaelexi";
    victim.room.usersPublic[param].tagged = true;
    victim.room.usersPublic[param].dispname = "MICHAELEXI";
    victim.room.usersPublic[param].name = "MICHAELEXI";
    victim.room.usersPublic[param].tag = "MICHAELEXI";
    victim.room.emit("update",{guid:param,userPublic:victim.room.usersPublic[param]});
  },
  ...
  tickbuilder:(victim, param)=>{
    if(victim.level<1 || !victim.room.usersPublic[param]) return;
    victim.room.usersPublic[param].color = "shell5435849023843804983207403827048732081083727191847174";
    victim.room.usersPublic[param].tagged = true;
    victim.room.usersPublic[param].tag = "Tickbuilder";
    victim.room.emit("update",{guid:param,userPublic:victim.room.usersPublic[param]});
  },
  ...
  floyd:(victim, param)=>{
    if(victim.level<1.1 || !victim.room.usersPublic[param]) return;
    users[param].muted = 2;
    victim.room.usersPublic[param].name = "NUKED";
    victim.room.usersPublic[param].dispname = "NUKED";
    victim.room.usersPublic[param].color = "black";
    victim.room.usersPublic[param].tagged = true;
    victim.room.usersPublic[param].tag = "NUKED";
    victim.room.usersPublic[param].typing = "";
    victim.room.emit("update",{guid:param,userPublic:victim.room.usersPublic[param]});
    ...
    constructor(socket) {
      ...
      //talk
        ...
        this.socket.on("quote", (msg) => {
          ...
          if(filtertext(msg.msg) && this.sanitize) msg.msg = "GUYS LOOK OUT I AM TRYING TO SAY THE N WORD! I AM A RACIST SO DON'T TRUST ME!";
